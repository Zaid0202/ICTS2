					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Internal Communication Ticketing ",
									"targetURL": "#internal-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"internal-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=internal",
									"url": sap.ui.require.toUrl("internal")
								}
							}
						}
					}
