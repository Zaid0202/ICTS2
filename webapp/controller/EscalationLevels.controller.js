sap.ui.define(
  ...
  function (BaseController, MessageBox) {
    ...
    return BaseController.extend("internal.controller.EscalationLevels", {
      onInit: async function () {
        await BaseController.prototype.onInit.apply(this, []);
        this.pageName = 'EscalationLevels'
        this.mainEndPoint = this.endsPoints['SettingsEscalation']
        ...
        this.mGroupFunctions = {
          ...
          EscalationLevels: function (oContext) {
            var name = oContext.getProperty();
            if (name && name.EscalationLevels) {
              console.log("data for EscalationLevels: ", name);
              return {
                key: name.EscalationLevels,
                text: name.EscalationLevels
              };
            } else {
              console.error("Invalid data for EscalationLevels: ", name);
              return {
                key: "Unknown",
                text: "Unknown"
              };
      ...
      oPayload_modify: function (oPayload) {
        ...
        oPayload['EscalationLevels'] = Number(oPayload['EscalationLevels'])
        return oPayload
      },
      ...
      generateRandomData: function () {
        ...
        randomObjData.EscalationLevels = Math.floor(Math.random() * 10) + 1; // EscalationLevels from 1 to 10
      ...
      //   //   { 'Text': 'Level', 'Key': 'EscalationLevels' }
      ...
      //     addUniqueItem(uniqueLevel, { Text: item.EscalationLevels, Key: "EscalationLevels" });
      //   });
